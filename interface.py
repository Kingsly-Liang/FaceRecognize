...
canvas.create_image(290,190,image = im)      # 使用create_image将图片添加到Canvas组件中
...
show = Tkinter.Button(root,text="show",width=10, height=2, command=show)   
